...
.\llama-server --model "D:\models\Qwen3.8-27B-NVFP4-MTP-MEDIUM.gguf" --alias "Qwen3.8-27B-Vision" --ctx-size 131072 --batch-size 4096 --ubatch-size 4096 --flash-attn on --cache-type-k q8_0 --cache-type-v q8_0 --temp 0.6 --top-p 1.0 --top-k 20 --min-p 0.0 --presence-penalty 0.0 --repeat-penalty 1.0 --spec-type draft-mtp --spec-draft-n-max 3 --spec-draft-p-min 0.8 --fit on --load-mode mlock --jinja --host 0.0.0.0 --port 8080 --threads 24 --api-key sk-123 --log-file %name%.log --image-min-tokens 1024 -n -1 -lv 4 --parallel 1 -ngl 999 --mmproj "D:\models\mmproj3.8-BF16.gguf"
