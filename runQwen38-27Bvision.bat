...
rem === model ===
set "args=--model "D:\models\Qwen3.8-27B-NVFP4-MTP-MEDIUM.gguf" --alias "Qwen3.8-27B-Vision""
rem === context ===
...
rem === vision ===
set "args=%args% --image-min-tokens 1024 --mmproj "D:\models\mmproj3.8-BF16.gguf""
